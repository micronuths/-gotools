...
func convertLagerLog(lagerLog config.LogFormat) (LogEntry, bool) {
	...
	var logErr error
	if lagerLog.LogLevel == config.ERROR || lagerLog.LogLevel == config.FATAL {
